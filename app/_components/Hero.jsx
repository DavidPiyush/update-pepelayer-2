...
import heroImage from "@/public/moneyFrog.png";
...
function Hero() {
  return (
    <section className="relative h-[90vh]">
      ...
      {/* Content Section */}
      <div className="relative z-20 flex flex-col md:flex-row items-center  h-full backdrop-blur-sm container-div gap-8">
        {/* Text Content */}
          ...
          <div className="flex my-12 gap-12 justify-center md:justify-start">
            <Link href="#">
              <svg
                ...
                height={54}
                fill="currentColor"
                className="bi bi-twitter-x fill-[#01241a]"
                viewBox="0 0 16 16"
              >
            ...
            <Link href="#">
              <svg
                ...
                height={54}
                fill="currentColor"
                className="bi bi-telegram fill-[#01241a]"
                viewBox="0 0 16 16"
              >
